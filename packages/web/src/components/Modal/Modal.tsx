...
import { ModalCompoundComponent } from "./types"
import { useModal } from "./StatefulModal"
...
const Modal: ModalCompoundComponent = ({ children, onRequestClose }) => {
...
Modal.ButtonsContainer = ModalButtonsContainer
Modal.Container = ModalContainer
Modal.Message = ModalMessageContainer
Modal.SecondaryMessage = ModalSecondaryMessageContainer
